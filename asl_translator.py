...
class ASLTranslator:
    ...
    def draw_ui_overlay(self, img, detected_letter, confidence, is_back_of_hand):
        ...
        if detected_letter:
            ...
            conf_color = self.color_primary if confidence > 0.7 else self.color_warning
    ...
    def run(self):
        ...
        while True:
                ...
                if landmarks:  # Removed strict stability requirement
                    ...
                    # Show detections with lower threshold
                    if current_letter and confidence > 0.65:  # Lowered from 0.75 to 0.65
                    ...
                    # Add to gesture timeline - lowered threshold
                    if current_letter and confidence > 0.70:  # Lowered from 0.80 to 0.70
                    ...
                    elif confidence < 0.65:  # Lowered rejection threshold
                        # Low confidence - ignore
                        current_letter = ""
                        confidence = 0.0
                
                # PRACTICE MODE: Check if detected letter matches target
                if self.practice_mode and current_letter and confidence > 0.8:
